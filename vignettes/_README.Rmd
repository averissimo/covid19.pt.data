...
if(age.ix.f != dgs.pt %>% pull(date) %>% max) {
  cat('*note: data update may be delayed by a couple of hours (as age data has been removed from daily report and we retrieve it from DGS\'s covid19 dashboard)*')
}
```
