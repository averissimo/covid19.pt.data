...
If you are here just for the data, this is what you want: [dgs_pt.csv](raw/master/data/dgs_pt.csv) or [covid19_pt.csv](raw/master/data/covid19_pt.csv) *(this dataset is an updated EU CDC data with Portugal only)*
