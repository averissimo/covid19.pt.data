...
if (nrow(age.data.all.new) > 0) {
  ...
  if (confirmed.status) {
    ...
    confirmed.labs$subtitle <- ' for new confirmed cases'
  ...
  if (death.status) {
    ...
    death.labs$caption <- ' for new deaths'
  }
  #
  #
  #
...
if (nrow(age.data.all) > 0) {
  ...
  if (confirmed.status) {
    confirmed.labs$title <- 'ERROR on DGS data for demographics'
    confirmed.labs$subtitle <- ' for total confirmed cases'
    confirmed.labs$caption <- ''
  }
  #
  ...
  if (death.status) {
    death.labs$title <- 'ERROR on DGS data for demographics'
    death.labs$subtitle <- ' for total deaths'
    death.labs$caption <- ''
  }
  #
  #
